...
| 索引名 | 类型 | 全局 | 字段 |
|--------|------|------|------|
| idx_settqrpquota | 默认 | 是 | stock_code, exchange_type, company_no, stock_code, exchange_type, company_no |
| idx_settqrpquota_company | 默认 | 是 | company_no, company_no |
| idx_settqrpquota | 默认 | 是 | stock_code, exchange_type, company_no, stock_code, exchange_type, company_no |
| idx_settqrpquota_company | 默认 | 是 | company_no, company_no |
...
| 索引名 | 字段 |
|--------|------|
| idx_qrpquota | stock_code, exchange_type, company_no, stock_code, exchange_type, company_no |
| idx_qrpquota_company | company_no, company_no |
| idx_qrpquota_date | init_date, stock_code, exchange_type, init_date, stock_code, exchange_type |
| idx_qrpquota | stock_code, exchange_type, company_no, stock_code, exchange_type, company_no |
| idx_qrpquota_company | company_no, company_no |
| idx_qrpquota_date | init_date, stock_code, exchange_type, init_date, stock_code, exchange_type |
