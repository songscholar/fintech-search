...
| 索引名 | 类型 | 全局 | 字段 |
|--------|------|------|------|
| idx_optsettcombhold | 默认 | 是 | optcomb_id, exchange_type, optcomb_id, exchange_type |
| idx_optsettcombhold | 默认 | 是 | optcomb_id, exchange_type, optcomb_id, exchange_type |
...
| 索引名 | 字段 |
|--------|------|
| idx_optsettcombhold | optcomb_id, exchange_type, optcomb_id, exchange_type |
| idx_optsettcombhold | optcomb_id, exchange_type, optcomb_id, exchange_type |
