...
| 日期 | 版本 | 作者 | 说明 |
|------|------|------|------|
| 2025-06-10 18:35:15 | 3.0.2.2002 | 高志强 | ses分支已删除该文件,合并后保留sms新增的自定义宏 |
| 2025-03-31 16:52:24 | 3.0.2.2001 | 蒋浩 | 新增插入表记录宏 |
| 2025-08-26 14:12:50 | 3.0.2.3 | 徐世晗 | 重新编译 |
...
【标签】
 支持M标识，打上M标识报错后不返回。
【范例】
[插入表记录][Entrust][entrust_status=2, exchange_type=@exchange_type_t]

<M>[插入表记录][Entrust][entrust_status=2, exchange_type=@exchange_type_t]
...
snprintf(@[标准字段], 11, "%02d%08d", @partition_no, @serial_no_x);
```
