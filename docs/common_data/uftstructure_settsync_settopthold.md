...
| 索引名 | 类型 | 全局 | 字段 |
|--------|------|------|------|
| idx_settopthold | 默认 | 是 | exchange_type, stock_account, branch_no, option_code, opthold_type, exchange_type, stock_account, branch_no, option_code, opthold_type |
| idx_settopthold | 默认 | 是 | exchange_type, stock_account, branch_no, option_code, opthold_type, exchange_type, stock_account, branch_no, option_code, opthold_type |
...
| 索引名 | 字段 |
|--------|------|
| idx_settopthold | exchange_type, stock_account, branch_no, option_code, opthold_type, exchange_type, stock_account, branch_no, option_code, opthold_type |
| idx_settopthold | exchange_type, stock_account, branch_no, option_code, opthold_type, exchange_type, stock_account, branch_no, option_code, opthold_type |
